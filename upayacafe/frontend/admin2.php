   ...
   class="icon <?= isset($activePage) && $activePage == 'settings.php' ? 'active' : '' ?>">⬅️</a> 
    ...
    <div class="menu-section">
      ...
      <div class="category-tabs">
        ...
        <button><a href="admin2.php"><h3>NON-COFFEE DRINKS</h3></a></button>
      ...
      <div class="product-grid">
        ...
        <div class="items">
          <div class="item">Blueberry Latte - 125</div>
          <div class="item">Strawberry Latte - 125</div>
          <div class="item">Chocolate Lava Latte - 135</div>
          <div class="item">Black Forest Latte - 150</div>
          <div class="item">Peach Latte - 135</div>
          <div class="item">Mango Latte - 135</div>
          <div class="item">Peach Mango Latte - 125</div>
          <div class="item">Passion Fruit Latte - 130</div>
