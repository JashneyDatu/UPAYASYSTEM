    ...
    <div class="menu-section">
      ...
      <div class="category-tabs">
       <button><a href="admin.php">COFFEE</a></button>
        ...
        <button><a href="admin4.php"><h3>FRUIT SODA</h3></a></button>
      ...
      <div class="product-grid">
        <h3>FRUIT SODA</h3>
        <div class="items">
          <div class="item">Strawberry Soda - 120</div>
          <div class="item">Blueberry Soda - 120</div>
          <div class="item">Lychee Soda - 120</div>
          <div class="item">Peach Soda - 120</div>
          <div class="item">Minty Peach Soda - 130</div>
          <div class="item">Kiwi Soda - 120</div>
          <div class="item">Green Apple Soda - 130</div>
