   ...
   class="icon <?= isset($activePage) && $activePage == 'settings.php' ? 'active' : '' ?>">⚙️</a> 
    ...
    <div class="menu-section">
      ...
      <div class="category-tabs">
        ...
        <button><a href="admin7.php"><h3>COOKIES & MUFFINS</h3></a></button>
      ...
      <div class="product-grid">
        <h3>COOKIES AND MUFFINS</h3>
        <div class="items">
          <div class="item">Oatmeal Cookie - 40</div>
          <div class="item">Chocolate Chip Cookie  - 45</div>
          <div class="item">Double Choco Chip Cookie - 50</div>
          <div class="item">Red Velvet Cookie - 55</div>
          <div class="item">Chocolate Chip Muffin - 55</div>
          <div class="item">Double Choco Chip Muffin - 60</div>
