   ...
   class="icon <?= isset($activePage) && $activePage == 'settings.php' ? 'active' : '' ?>">⬅️</a> 
    ...
    <div class="menu-section">
      ...
      <div class="category-tabs">
        ...
        <button><a href="admin3.php"><h3>FRAPPE</h3></a></button>
      ...
      <div class="product-grid">
        ...
        <div class="items">
          <div class="item">Chocolate Lava - 165</div>
          <div class="item">Strawberry - 165</div>
          <div class="item">Blueberry - 165</div>
          <div class="item">Blueberry & Strawberry - 165</div>
          <div class="item">Passion Fruit - 165</div>
          <div class="item">Peach - 165</div>
          <div class="item">Peach Mango - 175</div>
          <div class="item">Black Forest- 165</div>
          <div class="item">Matcha - 175</div>
          <div class="item">Strawberry Matcha - 165</div>
          <div class="item">Blueberry Matcha - 185</div>
          <div class="item">Chocolate Lava - 165</div>
          <div class="item">White Choco Matcha - 155</div>
          <div class="item">Oreo - 175</div>
          </div>

        <h3>FRAPPE (COFFEE)</h3>
        <div class="items">
          <div class="item">Caramel Popcorn - 165</div>
          <div class="item">Java Chip Frappe - 165</div>
          <div class="item">Biscoff Frappe - 165</div>
